...
document.addEventListener("DOMContentLoaded", function() {
    ...
    overlay.addEventListener("click", function() {
        ...
        const userId = '879145354573000714';
        ...
        fetch(`https://discord-lookup-api-alpha.vercel.app/v1/user/${userId}`)
            ...
            .then(data => {
                ...
                gameImage.src = 'https://cdn.pfps.gg/pfps/1515-cat-knife-gang-girl.gif'; // Placeholder image URL
                ...
                gameName.textContent = 'Counter-Strike 2';
